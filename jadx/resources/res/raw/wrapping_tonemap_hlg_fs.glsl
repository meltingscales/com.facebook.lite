...
const mat4 YUV_TO_RGB_REC2020 = mat4(
   1.167808,  1.167808,  1.167808, 0,
   0,        -0.187877,  2.148072, 0,
   1.683611, -0.652337,  0,        0,
  -0.914865,  0.347048, -1.147095, 1
);
const mat3 REC2020_BT709 = mat3(
...
highp vec3 BT2446_tone_mapping(highp vec3 rgb_BT2020) {
  ...
  // Divide by 0 is undefined behavior in EGL
  if(Y_prime == 0.0) {
   f_Y_prime_SDR = 0.0;
  }
