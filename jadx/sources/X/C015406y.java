...
public final class C015406y {
    ...
    public static C015406y A00(Context context, int i) {
        ...
        return new C015406y(applicationExitInfo, ActivityManager.isLowMemoryKillReportSupported());
    }
    ...
    public C015406y(ApplicationExitInfo applicationExitInfo, boolean z) {
        String obj;
        int indexOf;
        int indexOf2;
